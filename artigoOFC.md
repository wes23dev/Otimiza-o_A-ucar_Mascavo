...
O sucesso da produção de açúcar mascavo está intrinsecamente ligado ao ciclo biológico da cana-de-açúcar. A maturação da planta é o processo de acúmulo de sacarose nos colmos, medido tecnicamente pelo teor de Açúcar Total Recuperável (ATR). De acordo com o CONSECANA (2006), o ATR é o índice que expressa a quantidade de açúcares da cana que são passíveis de serem transformados em produto final (açúcar ou álcool) após o processamento industrial, servindo como a principal métrica de qualidade da matéria-prima.

Segundo Tomiya (1994), a maturação não é uniforme ao longo do ano; ela atinge seu pico em períodos de estiagem, quando a planta cessa o crescimento vegetativo e passa a estocar energia na forma de açúcar. A sazonalidade impõe uma janela de colheita restrita, geralmente entre maio e novembro na região Sudeste. Nesse contexto, a pluviosidade atua como um fator crítico: o excesso de chuvas aumenta o teor de água na planta, diluindo a concentração de sacarose e reduzindo o rendimento industrial por tonelada de cana processada. As variedades de cana são classificadas em precoces, médias e tardias, e o planejamento do mix de variedades é o que permite estender o período de safra com rendimentos viáveis (PIEDADE, 1989).

### 2.2 Gestão de Estoques de Antecipação e Realidade Familiar
A agroindústria lida com a oferta sazonal de matéria-prima para uma demanda que costuma ser constante ao longo dos 12 meses do ano. Para garantir a continuidade das vendas durante a entressafra (dezembro a abril), utiliza-se o conceito de Estoque de Antecipação.

Conforme Souza (2022), o estoque funciona como um amortecedor (buffer) que absorve a superprodução dos meses de safra para suprir a carência dos períodos onde a colheita é impossibilitada. Em unidades de gestão familiar, a posse de infraestrutura própria de armazenagem (galpões próprios) é um ativo estratégico fundamental. Embora elimine o custo direto de aluguel, a manutenção desse estoque envolve o custo de oportunidade do capital parado e o risco de deterioração do produto, exigindo que a quantidade estocada seja calculada com precisão para evitar a Ruptura de Estoque (COLIN, 2001).

### 2.3 Pesquisa Operacional e Modelagem Matemática no Campo
Para resolver o conflito entre a produção limitada pela safra e a necessidade de estoque para o ano todo, a Pesquisa Operacional (PO) oferece métodos quantitativos de suporte à decisão. A Programação Linear (PL) destaca-se como uma técnica de otimização que busca a melhor alocação de recursos escassos através de relações lineares.

Segundo Caixeta-Filho (2001), a aplicação de modelos matemáticos no planejamento agrícola permite transformar variáveis complexas — como clima, produtividade por variedade e janelas de colheita — em decisões estruturadas que minimizam custos operacionais. A eficácia dessa técnica na agroindústria é amplamente documentada por Taube-Netto (1996), que demonstra que o uso da PO reduz a subjetividade da gestão empírica e permite a realização de análises de sensibilidade, fundamentais para prever o impacto de variações climáticas severas.
